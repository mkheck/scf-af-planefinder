...
public class AircraftPosition {
    ...
    public AircraftPosition(String adshex) {
        this.adshex = adshex;
    }

    public AircraftPosition(String callsign, String reg, String flightno, String type,
                            int altitude, int heading, int speed,
                            double lat, double lon) {

        this("000000", callsign, "sqwk", reg, flightno, "route", type, "ct",
